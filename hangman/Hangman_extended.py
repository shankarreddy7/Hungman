...
class Hangman:
    ...
    def __init__(self, name, word_list, num_lives=6, x=0):
        ...
        print(f"Hello {self.name}, welcome to our human anatomy hangman. This is a game where a random part in your body is presented and you will have six tries to guess that part or you will lose it. Good luck!")
        self.word_list = word_list
        self.num_lives = num_lives
        self.word = random.choice(word_list)
        print(f"The mystery word consists of {len(self.word)} characters")
        self.word_guessed = []
   ...
   /|   |
    ...
    O   |
        ...
        |
       ===''')
                  print('\n you lost your head. You lost, sorry!')
...
if __name__ == '__main__':
    word_list = ['medulla', 'carpals', 'febula', 'mandible', 'clavicle','duodenum']
    play_game(word_list)
